...
public class IngresosFragment extends Fragment {
    ...
    public static IngresosFragment newInstance(int page, String title) {
        IngresosFragment fragmentFirst = new IngresosFragment();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        title = getArguments().getString("Ingresos");
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        this.view = inflater.inflate(R.layout.ingresos_fragment, container, false);
